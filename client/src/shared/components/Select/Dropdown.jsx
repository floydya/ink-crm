    ...
    <Dropdown width={dropdownWidth}>
      ...
      <Options ref={$optionsRef}>
        {filteredOptions.map(option => (
          <Option
            ...
            style={{
              ...
              backgroundColor: option.disabled && color.backgroundLightDanger
            }}
          >
        ...
        {isOptionCreatable && (
          ...
          >
            {isCreatingOption ? `Создание "${searchValue}"...` : `Создать "${searchValue}"`}
          </Option>
        )}
      </Options>

      {filteredOptions.length === 0 && <OptionsNoResults>Нет результатов</OptionsNoResults>}
    </Dropdown>
  )
}
