...
import { IssueStatus, IssuePriority, NotificationType } from "../constants/issues"
...
export const notificationTypeColors = {
  [NotificationType.INFO]: '#4FADE6', // blue
  [NotificationType.DANGER]: '#E44D42', // red
  [NotificationType.SUCCESS]: '#65BA43', // green
  [NotificationType.WARNING]: '#E97F33', // orange
};
